...
<html>
  ...
  <body runat="server" id="Body" class="scWindowBorder1" onmousedown="javascript:scWin.mouseDown(this, event)"
    ...
    <sc:CodeBeside runat="server" Type="Sitecore.Support.Shell.Applications.ContentManager.ContentEditorForm, Sitecore.Support.149586" />
    ...
    <telerik:RadSpell ID="RadSpell" SpellCheckProvider="EditDistanceProvider" EditDistance="2" runat="server" />
        ...
        <div class="scStretchAbsolute scContentEditorSplitter">
          <div id="ContentTreePanel">
            <div class="scFlexColumnContainerWithoutFlexie" style="height: 100%;width: 100%;position: relative" >
              <div id="SearchPanel" runat="server" style="background: #e9e9e9; border-bottom: 1px solid #4c4c4c">
                <table width="100%">
                  <tr>
